...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__14940){
var vec__14941 = p__14940;
var task_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14941,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14941,(1),null);
var length = cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core._PLUS_,(function (){var iter__4523__auto__ = ((function (vec__14941,task_name,v){
return (function pomodoro$summary$sum_usage_$_iter__14944(s__14945){
return (new cljs.core.LazySeq(null,((function (vec__14941,task_name,v){
return (function (){
var s__14945__$1 = s__14945;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__14945__$1);
if(temp__5720__auto__){
var s__14945__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__14945__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__14945__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__14947 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__14946 = (0);
while(true){
if((i__14946 < size__4522__auto__)){
var d = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__14946);
cljs.core.chunk_append(b__14947,cljs.core.cst$kw$duration.cljs$core$IFn$_invoke$arity$1(d));

var G__14948 = (i__14946 + (1));
i__14946 = G__14948;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__14947),pomodoro$summary$sum_usage_$_iter__14944(cljs.core.chunk_rest(s__14945__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__14947),null);
}
} else {
var d = cljs.core.first(s__14945__$2);
return cljs.core.cons(cljs.core.cst$kw$duration.cljs$core$IFn$_invoke$arity$1(d),pomodoro$summary$sum_usage_$_iter__14944(cljs.core.rest(s__14945__$2)));
}
} else {
return null;
}
...
return (function pomodoro$summary$summary_$_iter__14949(s__14950){
return (new cljs.core.LazySeq(null,((function (history,full_width,width){
return (function (){
var s__14950__$1 = s__14950;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__14950__$1);
if(temp__5720__auto__){
var s__14950__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__14950__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__14950__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__14952 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__14951 = (0);
while(true){
if((i__14951 < size__4522__auto__)){
var task = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__14951);
cljs.core.chunk_append(b__14952,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$tr,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$key,cljs.core.cst$kw$task_DASH_name.cljs$core$IFn$_invoke$arity$1(task)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$td,cljs.core.cst$kw$task_DASH_name.cljs$core$IFn$_invoke$arity$1(task)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$td,pomodoro.time_format.render_time(cljs.core.cst$kw$length.cljs$core$IFn$_invoke$arity$1(task))], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$td,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$width,width], null)], null),pomodoro.ui_common.button_element((function (){var G__14954 = cljs.core.cst$kw$active;
...
})(),width,pomodoro.dictionary.get_text.cljs$core$IFn$_invoke$arity$3(state,cljs.core.cst$kw$restart,width),((function (i__14951,task,c__4521__auto__,size__4522__auto__,b__14952,s__14950__$2,temp__5720__auto__,history,full_width,width){
return (function (){
...
});})(i__14951,task,c__4521__auto__,size__4522__auto__,b__14952,s__14950__$2,temp__5720__auto__,history,full_width,width))
)], null)], null));

var G__14957 = (i__14951 + (1));
i__14951 = G__14957;
continue;
} else {
return true;
...
})(),width,pomodoro.dictionary.get_text.cljs$core$IFn$_invoke$arity$3(state,cljs.core.cst$kw$restart,width),((function (task,s__14950__$2,temp__5720__auto__,history,full_width,width){
return (function (){
return pomodoro.action.restart(state,cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(task,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$length], null),cljs.core.quot,(1000)));
});})(task,s__14950__$2,temp__5720__auto__,history,full_width,width))
)], null)], null),pomodoro$summary$summary_$_iter__14949(cljs.core.rest(s__14950__$2)));
}
} else {
return null;
}
