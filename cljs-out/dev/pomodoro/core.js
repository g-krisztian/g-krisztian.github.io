...
pomodoro.core.app_state = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 7, [cljs.core.cst$kw$get_DASH_key,pomodoro.cookie_storage.get_key,cljs.core.cst$kw$length,(25),cljs.core.cst$kw$elapsed,(0),cljs.core.cst$kw$task_DASH_name,"Default",cljs.core.cst$kw$now,(new Date()).getTime(),cljs.core.cst$kw$view,cljs.core.cst$kw$single_DASH_run,cljs.core.cst$kw$unit,(function (){var or__4131__auto__ = pomodoro.cookie_storage.get_unit();
...
pomodoro.action.set_title(pomodoro.core.app_state);

if(cljs.core.truth_(cljs.core.cst$kw$dictionary.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(pomodoro.core.app_state)))){
return pomodoro.main.main.cljs$core$IFn$_invoke$arity$variadic(pomodoro.core.app_state,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([pomodoro.main.choose_view(pomodoro.core.app_state),pomodoro.main.show_view(pomodoro.core.app_state)], 0));
} else {
return null;
}
});
