...
var str_delete = ((((550) < full_width))?pomodoro.action.dict(state,cljs.core.cst$kw$remove):"Delete");
if(cljs.core.seq_QMARK_(history)){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$table,new cljs.core.PersistentArrayMap(null, 3, [cljs.core.cst$kw$class,"table table-striped table-bordered",cljs.core.cst$kw$id,"history",cljs.core.cst$kw$style,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$width,full_width], null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$thead,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$class,"thead-dark"], null),new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$tr,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$th,pomodoro.action.dict(state,cljs.core.cst$kw$task_DASH_name)], null),((((550) < full_width))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$th,pomodoro.action.dict(state,cljs.core.cst$kw$start_DASH_time)], null):null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$th,pomodoro.action.dict(state,cljs.core.cst$kw$planed_DASH_duration)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$th,pomodoro.action.dict(state,cljs.core.cst$kw$real_DASH_duration)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$th,pomodoro.ui_common.button_element((function (){var G__14913 = cljs.core.cst$kw$active;
...
})(),width,pomodoro.action.dict(state,cljs.core.cst$kw$restart),((function (i__14916,task,c__4521__auto__,size__4522__auto__,b__14917,s__14915__$2,temp__5720__auto__,history,full_width,width,str_delete){
return (function (){
return pomodoro.action.restart(state,task);
});})(i__14916,task,c__4521__auto__,size__4522__auto__,b__14917,s__14915__$2,temp__5720__auto__,history,full_width,width,str_delete))
)], null)], null));
...
})(),width,pomodoro.action.dict(state,cljs.core.cst$kw$restart),((function (task,s__14915__$2,temp__5720__auto__,history,full_width,width,str_delete){
return (function (){
return pomodoro.action.restart(state,task);
});})(task,s__14915__$2,temp__5720__auto__,history,full_width,width,str_delete))
