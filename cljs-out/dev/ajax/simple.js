...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__14643){
var map__14644 = p__14643;
var map__14644__$1 = (((((!((map__14644 == null))))?(((((map__14644.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14644.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14644):map__14644);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14644__$1,cljs.core.cst$kw$handler);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__4131__auto__ = p1__14646_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__14647){
var map__14648 = p__14647;
var map__14648__$1 = (((((!((map__14648 == null))))?(((((map__14648.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14648.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14648):map__14648);
var request = map__14648__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14648__$1,cljs.core.cst$kw$interceptors);
